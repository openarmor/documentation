  ...
  ($(document).ready(function () {
    if (window.matchMedia) {
      ...
      $.each(n, function (e, t) {
        ...
        function o() {
          r.matches && (n.remove(), (n = $(t).appendTo("head")));
        }
        r.addListener(o), o();
      });
    }
...
function markTocNodesWithClass(e, r, o) {
...
$(function () {
  ...
  jQuery(function (u) {
    ...
    (a = u("#version-selector .current")),
      ...
      0 < p.length
        ? a.html("Version " + s + (s == p[0] ? " (current)" : ""))
        : a.html("Version " + s);
    let n = t();
    ...
    });
    {
      ...
      if (t !== r) {
        ...
        n.hasOwnProperty(r) && (e += a[r]), s && s.setAttribute("href", e);
      }
    }
    a = Object.keys(n);
    let e = a[a.length - 1];
    ...
    function t() {
      ...
      (a =
        "/" ==
        (a = (o ? t.split(document.location.host) : t.split("/html"))[1])[
          a.length - 1
        ]
          ? a + "index.html"
          : a).indexOf(f)
        ? "/" !== (a = a.split("/" + f)[1])[a.length - 1] &&
      ...
      var d = (function (o, e, t, n, a, s) {
        ...
        for (; c.length; ) {
          ...
          for (
            ...
            var m = t.pop(),
              ...
              w = m.direction,
              m = S(m.release, o),
              m = { page: g, version: v, versionNum: m, direction: w };
            c.push(m), (l[v] = g);
          }
          if (1e3 <= u) return !(c = []);
          u++;
        }
        for (x in ((historyArray1 = A("toBottom", l, h, o)),
        (historyArray2 = A("toTop", l, h, o)),
        historyArray1))
        ...
        if (!1 !== e) {
          ...
          for (r in i)
            ({}).hasOwnProperty.call(i, r) &&
              ((y = S(r, o)), parseInt(y) >= parseInt(E)) &&
              delete i[r];
        }
        return i;
      })(h, f, a, newUrls, redirections, removedUrls);
      h = h.reverse();
      for (let e = 0; e < p.length; e++)
        (l = ""),
          (c = ""),
          null != d[(i = h[e])] && d[i].length
            ? (l = 0 == e ? "/current" + d[i] + s : "/" + i + d[i] + s)
            : (c =
          ...
          (n +=
            ...
            (0 == e ? " (current)" : "") +
            "</a></li>"),
          i == p[0] && u(".no-latest-notice .link-latest").attr("href", l);
      return e.html(n), d;
    }
    function m(t) {
        ...
        for (forTarget in l.target)
          ({}).hasOwnProperty.call(l.target, forTarget) &&
            ...
            ("toBottom" != e.direction &&
              ...
              o.push({ release: a[1], direction: "toTop", url: l[a[1]] }),
            "toTop" != e.direction) &&
            i < s &&
            parseInt(e.versionNum) >= s &&
            o.push({ release: a[1], direction: "toBottom", url: l[a[1]] });
      }
      return o;
    }
    function A(e, t, r, o) {
          ...
          "toBottom" == e &&
            ...
            (null == t[o[forVersions]]
              ? forVersions != o.length - 1 &&
                ...
                (a[o[forVersions]] = t[o[n]])
              : (a[o[forVersions]] = t[o[forVersions]])),
          "toTop" == e) &&
          forVersions >= r &&
          (null == t[o[forVersions]]
            ? 0 != forVersions &&
  ...
  _highlight = (t, r, o, n) => {
    if (t.nodeType === Node.TEXT_NODE) {
      ...
      if (
        ...
        let e;
        var l = s.closest("body, svg, foreignObject"),
          l = l && l.matches("svg");
        l
          ...
          : (e = document.createElement("span")).classList.add(n),
          e.appendChild(document.createTextNode(a.substr(i, o.length))),
          s.insertBefore(
            e,
            s.insertBefore(
              document.createTextNode(a.substr(i + o.length)),
              t.nextSibling
            )
          ),
          (t.nodeValue = a.substr(0, i)),
          l &&
            ...
            (i = s.getBBox()),
            (a.x.baseVal.value = i.x),
            (a.y.baseVal.value = i.y),
            (a.width.baseVal.value = i.width),
            (a.height.baseVal.value = i.height),
      ...
      t.matches &&
        ...
        t.childNodes.forEach((e) => _highlight(e, r, o, n));
  },
...
function init() {
  new MutationObserver(function (e, t) {
    for (i = 0; i < e.length; i++)
      "childList" === e[i].type &&
        e[i].addedNodes[0] &&
        e[i].addedNodes[0].classList.contains("redoc-wrap") &&
        document.querySelector(".loading").classList.remove("loading");
  }).observe(document.querySelector("redoc[spec-url]"), { childList: !0 });
}
function checkMenu(r) {
  var e;
  r &&
    ((e = { attributes: !null }),
    new MutationObserver(function (e, t) {
      for (i = 0; i < e.length; i++)
        "open" == e[i].attributeName &&
          (document
            .querySelector("redoc[spec-url] .menu-content")
            .hasAttribute("open")
            ? r.classList.remove("collapsed")
            : r.classList.add("collapsed"));
    }).observe(document.querySelector("redoc[spec-url] .menu-content"), e));
}
_ready(SphinxHighlight.highlightSearchWords),
  _ready(SphinxHighlight.initEscapeListener),
  init();
//# sourceMappingURL=api-reference.min.js.map
