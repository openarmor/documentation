if (
  ($(document).ready(function () {
    if (window.matchMedia) {
      let o = $('head > link[rel="icon"][media]');
      $.each(o, function (e, t) {
        let r = window.matchMedia(t.media);
        function n() {
          r.matches && (o.remove(), (o = $(t).appendTo("head")));
        }
        r.addListener(n), n();
      });
    }
...
!(function (r) {
  window.matchMedia("(hover: hover)").matches &&
    (r(".navbar-nav .dropdown-toggle").on("mouseenter", function (e) {
      r(this).closest(".dropdown").hasClass("show") ||
        (e.stopPropagation(), r(this).trigger("click"));
    }),
    r(".navbar-nav .dropdown-toggle").on("mouseleave", function (e) {
      var t = e.toElement || e.relatedTarget;
      r(this).closest(".dropdown").hasClass("show") &&
        t !== r(this).siblings()[0] &&
        (e.stopPropagation(), r(this).trigger("click"));
    }),
    r(".navbar-nav .dropdown-menu").on("mouseleave", function (e) {
      e = e.toElement || e.relatedTarget;
      r(this).closest(".dropdown").hasClass("show") &&
        e !== r(this).siblings()[0] &&
        r(this).siblings().trigger("click");
    }));
})(jQuery),
  (function (r) {
    window.matchMedia("(hover: hover)").matches &&
      (r("#toggle-full-footer").on("mouseenter", function (e) {
        r(".website-links").hasClass("show") ||
          (e.stopPropagation(), r("#toggle-full-footer").trigger("click"));
      }),
      r("#toggle-full-footer-wrapper").on("mouseleave", function (e) {
        var t = e.toElement || e.relatedTarget;
        r(".website-links").hasClass("show") &&
          t !== r(this).siblings()[0] &&
          (e.stopPropagation(), r("#toggle-full-footer").trigger("click"));
...
if (0 < switchButton.length) {
  ...
  "dark" == (r = r || (e.matches ? "dark" : "light"))
    ? t.text("Switch to light mode")
    : "light" == r
    ? t.text("Switch to dark mode")
    : t.text("Switch mode"),
    switchButton.attr("class", r),
...
if (
  ...
  jQuery(function (u) {
    ...
    (a = u("#version-selector .current")),
      (s = DOCUMENTATION_OPTIONS.VERSION),
      0 < f.length
        ? a.html("Version " + s + (s == f[0] ? " (current)" : ""))
        : a.html("Version " + s);
    let o = t();
    ...
    });
    {
      ...
      let t = DOCUMENTATION_OPTIONS.VERSION,
        ...
        n = "";
      if (t !== r) {
        "/" == (n = document.location.pathname)[n.length - 1] &&
          (n += "index.html"),
          -1 != n.indexOf(t)
            ? (n = n.split("/" + t)[1])
            : -1 != n.indexOf("current") && (n = n.split("/current")[1]);
        var s = document.querySelector(".link-latest");
        let e = "https://" + window.location.hostname + "/current";
        o.hasOwnProperty(r) && (e += a[r]), s && s.setAttribute("href", e);
      }
    }
    a = Object.keys(o);
    let e = a[a.length - 1];
    ...
    function t() {
      ...
      (a =
        "/" ==
        (a = (n ? t.split(document.location.host) : t.split("/html"))[1])[
          a.length - 1
        ]
          ? a + "index.html"
          : a).indexOf(p)
        ? "/" !== (a = a.split("/" + p)[1])[a.length - 1] &&
          (((a = a.split("/"))[0] = ""), (a = a.join("/")))
        : -1 != a.indexOf("current") && (a = a.split("/current")[1]),
        (t = a.split("?")),
        (a = m(t[0])),
        (s = 2 == t.length ? "?" + t[1] : "");
      let i,
      ...
      var d = (function (n, e, t, o, a, s) {
        ...
        for (; c.length; ) {
          ...
          for (
            ...
            var m = t.pop(),
              ...
              v = m.direction,
              m = N(m.release, n),
              m = { page: g, version: T, versionNum: m, direction: v };
            c.push(m), (i[T] = g);
          }
          if (1e3 <= u) return !(c = []);
          u++;
        }
        for (x in ((historyArray1 = I("toBottom", i, h, n)),
        (historyArray2 = I("toTop", i, h, n)),
        historyArray1))
            ...
            if ({}.hasOwnProperty.call(t, forRelease))
              for (forUrl in t[forRelease])
                !{}.hasOwnProperty.call(t[forRelease], forUrl) ||
                  ...
                  (((r = []).release = forRelease),
                  (r.url = t[forRelease][forUrl]));
          return r;
        })(l[n[0]], o);
        if (!1 !== t) {
          var O,
        ...
        if (!1 !== e) {
          ...
          for (r in l)
            ({}).hasOwnProperty.call(l, r) &&
              ((S = N(r, n)), parseInt(S) >= parseInt(y)) &&
              delete l[r];
        }
        return l;
      })(h, p, a, newUrls, redirections, removedUrls);
      h = h.reverse();
      for (let e = 0; e < f.length; e++)
        (i = ""),
          (c = ""),
          null != d[(l = h[e])] && d[l].length
            ? (i = 0 == e ? "/current" + d[l] + s : "/" + l + d[l] + s)
            : (c =
          ...
          (o +=
            ...
            (0 == e ? " (current)" : "") +
            "</a></li>"),
          l == f[0] && u(".no-latest-notice .link-latest").attr("href", i);
      return e.html(o), d;
    }
    function m(t) {
      ...
      for (var n = [], o = t; o.length; ) {
        ...
        for (forTarget in i.target)
          ({}).hasOwnProperty.call(i.target, forTarget) &&
            ((a = i.target[forTarget].split("=>")),
            (s = parseInt(N(a[0], r))),
            (l = parseInt(N(a[1], r))),
            e.page == i[a[0]]) &&
            ("toBottom" != e.direction &&
              s < l &&
              parseInt(e.versionNum) <= s &&
              n.push({ release: a[1], direction: "toTop", url: i[a[1]] }),
            "toTop" != e.direction) &&
            l < s &&
            parseInt(e.versionNum) >= s &&
            n.push({ release: a[1], direction: "toBottom", url: i[a[1]] });
      }
      return n;
    }
    function I(e, t, r, n) {
      var o,
        a = [];
      for (forVersions in n)
        ({}).hasOwnProperty.call(n, forVersions) &&
          ((forVersions = parseInt(forVersions)),
          "toBottom" == e &&
            forVersions < r &&
            (null == t[n[forVersions]]
              ? forVersions != n.length - 1 &&
                -1 !=
                  (o = (function (e, t, r) {
                    let n = -1;
                    for (i in t)
                ...
                (a[n[forVersions]] = t[n[o]])
              : (a[n[forVersions]] = t[n[forVersions]])),
          "toTop" == e) &&
          forVersions >= r &&
          (null == t[n[forVersions]]
            ? 0 != forVersions &&
...
let BLACKLISTED_KEY_CONTROL_ELEMENTS = new Set([
  ...
  Documentation = {
    ...
    ngettext: (e, t, r) => {
      var n = Documentation.TRANSLATIONS[e];
      return "undefined" != typeof n
        ? n[Documentation.PLURAL_EXPR(r)]
        : 1 === r
        ? e
        : t;
    },
  ...
  _highlight = (t, r, n, o) => {
    if (t.nodeType === Node.TEXT_NODE) {
      var a = t.nodeValue,
        s = t.parentNode,
        l = a.toLowerCase().indexOf(n);
      if (
        0 <= l &&
        !s.classList.contains(o) &&
        !s.classList.contains("nohighlight")
      ) {
        let e;
        var i = s.closest("body, svg, foreignObject"),
          i = i && i.matches("svg");
        i
          ...
          : (e = document.createElement("span")).classList.add(o),
          e.appendChild(document.createTextNode(a.substr(l, n.length))),
          s.insertBefore(
            e,
            s.insertBefore(
              document.createTextNode(a.substr(l + n.length)),
              t.nextSibling
            )
          ),
          (t.nodeValue = a.substr(0, l)),
          i &&
            ...
            (l = s.getBBox()),
            (a.x.baseVal.value = l.x),
            (a.y.baseVal.value = l.y),
            (a.width.baseVal.value = l.width),
            (a.height.baseVal.value = l.height),
            a.setAttribute("class", o),
            r.push({ parent: s, target: a }));
      }
    } else
      t.matches &&
        !t.matches("button, select, textarea") &&
        t.childNodes.forEach((e) => _highlight(e, r, n, o));
  },
  _highlightText = (e, t, r) => {
    var n = [];
    _highlight(e, n, t, r),
      n.forEach((e) => e.parent.insertAdjacentElement("beforebegin", e.target));
  },
  SphinxHighlight = {
    highlightSearchWords: () => {
      if (SPHINX_HIGHLIGHT_ENABLED) {
        var r = new URL(window.location),
          n =
            localStorage.getItem("sphinx_highlight_terms") ||
            r.searchParams.get("highlight") ||
            "";
        localStorage.removeItem("sphinx_highlight_terms"),
          r.searchParams.delete("highlight"),
        ...
        let e = n
          ...
          .filter((e) => e);
        if (0 !== e.length) {
          r = document.querySelectorAll("main>section");
          let t = r.length ? r[0] : document.querySelector("body");
          window.setTimeout(() => {
            e.forEach((e) => _highlightText(t, e, "highlighted"));
          }, 10);
          n = document.getElementById("searchbox");
          null !== n &&
            n.appendChild(
              document
                .createRange()
  ...
  pagefindUrl =
    "file:" === location.protocol
      ? ""
      : location.href.split("search.html")[0] + "_pagefind/pagefind.js";
if ($(".search")) {
  let n = new URLSearchParams(window.location.search),
    s = "#search-results";
  function loadSphinxSearch() {
    getScript(
      DOCUMENTATION_OPTIONS.URL_ROOT + "_static/js/min/sphinx-search-ui.min.js"
    ),
      getScript(DOCUMENTATION_OPTIONS.URL_ROOT + "searchindex.js");
  }
  function getScript(e) {
    (loadScript = document.createElement("SCRIPT")).setAttribute(
      "charset",
      "utf-8"
    ),
      loadScript.setAttribute("type", "text/javascript"),
      loadScript.setAttribute("src", e),
      document.getElementsByTagName("head")[0].appendChild(loadScript);
  }
  pagefindUrl.length
    ? fetch(pagefindUrl, { method: "HEAD" }).then((e) => {
        if (200 !== e.status || !0 === e.redirected) loadSphinxSearch();
        else {
          window.pagefind = import(pagefindUrl);
          let a,
            u = 0;
          pagefind.then(function (e) {
            let t = e.search,
              o = n.get("q");
            if ("string" == typeof o) {
              let d = new Set();
              function r(i) {
                ...
                $(t).text("Search results for: "),
                  $('<span class="query-term"></span>').appendTo(t).text(o),
                  e.append(t);
                let r = $(
                    '<p class="search-summary" style="display: none;">&nbsp;</p>'
                  ).appendTo(e),
                  c = $('<ul class="search-ul"/>').appendTo(e);
                r.fadeIn(500);
                var n = [];
                let h = location.href
                  .split("search.html")[0]
                ...
                for (let l = 0; l < a; l++)
                  n.push(
                    i[l].data().then((e) => {
                      let r = $('<li style="display:none"></li>'),
                        t = "";
                      (path =
                        "" == h || "/" == h
                          ? e.url.substring(1)
                        ...
                        "/" ==
                          (t =
                            "./" !== DOCUMENTATION_OPTIONS.URL_ROOT
                              ? DOCUMENTATION_OPTIONS.URL_ROOT + path
                              : t)[t.length - 1] && (t += "index.html"),
                        (n = $("<a/>")
                          .attr("href", t)
                          .text(e.meta.title)
                          .addClass("result-link")),
                        r.append(n),
                        (n = createResultBreadcrumb(n)),
                        r.append(n);
                      for (
                        var n = i[l].excerpt_range,
                          o = i[l].words,
                          a = e.content.split(" "),
                          s = 0;
                        s < o.length;
                        ...
                        d.add(a[o[s]]),
                          (a[o[s]] = "<mark>" + a[o[s]] + "</mark>");
                      (e = 0 < n[0] ? "..." : ""),
                        (e =
                          (e += a
                            .slice(
                              i[l].excerpt_range[0],
                              i[l].excerpt_range[0] + i[l].excerpt_range[1]
                            )
                            .join(" ")) +
                          (n[0] + n[1] - 1 < a.length ? "..." : "")),
                        (n = $("<div/>")
                          ...
                          .html(e.replace("¶", "")));
                      r.append(n),
                        $.each(excludedSearchFolders, function (e, t) {
                          if (path.includes(t + "/"))
                            return (
                              u++,
                              r.addClass("excluded-search-result"),
                              r.addClass("hidden-result"),
                              !1
                            );
                        }),
                        c.append(r),
                        r.hasClass("hidden-result") || r.fadeIn(100);
                    })
                  );
                Promise.allSettled(n).then(([]) => {
                  updateSearchStatus(r, a, u),
...
function createResultBreadcrumb(e) {
  let r = [],
    t = e.attr("href").split("?")[0],
    n = $("#global-toc").find('[href="' + t + '"]');
  0 === n.length &&
    "/" === t.substring(t.length - 1) &&
    ((t += "index.html"), (n = $("#global-toc").find('[href="' + t + '"]'))),
  ...
  var o = $(document.createElement("span")),
    a =
      (o.addClass("breadcrumb-separator").attr("aria-hidden", "true"),
      $(document.createElement("nav")));
  a.addClass("breadcrumbs");
  for (let t = 0; t < r.length; t++) {
    let e = $(document.createElement("a"));
    e.attr("href", r[t].url).text(r[t].text).addClass("breadcrumb-link"),
      a.prepend(e),
      a.prepend(o.clone(!0));
  }
  ...
  var e = $("#home-icon svg"),
    l =
      "/" === (l = DOCUMENTATION_OPTIONS.URL_ROOT)[l.length - 1]
        ? l + "index.html"
        : l + "/index.html";
  return (
    s.attr("href", l).append(e.clone(!0)).addClass("breadcrumb-link"),
    a.prepend(s),
    a
  );
}
function updateSearchStatus(t, r, n) {
  if (0 == r)
    t.text("No results."),
      $(
        "<p>Please make sure that all words are spelled correctly.</p>"
      ).appendTo(t);
  else {
    let e = "";
    (e =
      0 < n
        ? 'Found <span id="n-results">' +
          (r - n) +
          '</span> page(s) matching the search query. <a id="toggle-results" class="include" href="#">Include Release Notes results</a>'
        : 'Found <span id="n-results">' +
          r +
          "</span> page(s) matching the search query."),
      t.html(e);
  }
}
$(document).delegate(
  "#search-results #toggle-results.include",
  "click",
  function () {
    var e = $(this),
      t = $("ul.search-ul li.excluded-search-result");
    e.text(e.text().replace("Include", "Exclude")),
      e.removeClass("include").addClass("exclude"),
      $("#search-results #n-results").text($("ul.search-ul li").length),
      t.each(function (e) {
        (currentResult = $(this)).show("fast");
      });
  }
),
  $(document).delegate(
    "#search-results #toggle-results.exclude",
    "click",
    function () {
      var e = $(this),
        t = $("ul.search-ul li.excluded-search-result");
      e.text(e.text().replace("Exclude", "Include")),
        e.removeClass("exclude").addClass("include"),
        $("#search-results #n-results").text(
          $("ul.search-ul li").length - t.length
        ),
        t.each(function (e) {
          (currentResult = $(this)).hide("normal", function () {
