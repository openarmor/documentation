...
Install Armor server from sources
=================================
...
4. The script will ask about what kind of installation you want. Type ``server`` to install Armor Manager:
...
1. NodeJS >= 4.6.1 is required in order to run the Armor API. If you do not have NodeJS installed or your version is older than 4.6.1, we recommend you add the official repository as this has more recent versions.
...
2. Download and execute the installation script:
  ...
  .. code-block:: bash
      ...
      $ curl -s -o install_api.sh https://raw.githubusercontent.com/armor/armor-api/v|ARMOR_LATEST|/install_api.sh && bash ./install_api.sh download
...
.. note:: You can also run an :doc:`unattended installation<../unattended-installation>` of the Armor manager and API.

Installing Filebeat
-------------------

While Filebeat can be installed from source (`see this doc <https://github.com/elastic/beats/blob/master/CONTRIBUTING.md>`_), the process is more complex than you may like, and it is beyond the scope of Armor documentation. We recommend installing Filebeat via repository package, otherwise, you can install it from a binary tarball, that's should work for any Linux distro.  See more `here <https://www.elastic.co/downloads/beats/filebeat>`_.
