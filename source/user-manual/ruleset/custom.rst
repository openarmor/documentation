...
It is possible to modify the default rules and decoders from the Armor Ruleset and also to add new ones in order to increase Armor's detection capabilities.
