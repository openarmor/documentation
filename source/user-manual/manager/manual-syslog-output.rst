...
Armor may be configured to send alerts to syslog as follows:
...
After the configuration of the ``ossec.conf`` file, the client-syslog must be enabled followed by a restart of Armor using the following command:
