...
This section describes the checks performed by Armor to find the anomalies caused by an intruder or malware.
...
Example:
  ...
  If you create a hidden file on /dev, Armor should alert because there is a hidden file in a directory that should only contain device-specific files. This is the alert generated in that case::
