...
project = u'OpenArmor'
author = u'OpenArmor, Inc.'
copyright = u'&copy; ' + str(datetime.datetime.now().year) + u'OpenArmor Inc.'
...
extensions = [
    ...
    'sphinx_tabs.tabs',
    'armor-doc-images', # Custom extension
    'sphinx_reredirects'
]
...
# of the sidebar.
html_logo = theme_assets_path + '/static/images/armor-logo.png'
...
htmlhelp_basename = 'OpenArmorDocs'
...
latex_documents = [
    (master_doc, 'ArmorDocs.tex', u'Documentation', u'Armor, Inc.', 'manual'),
]
...
man_pages = [
    (master_doc, 'armordocs', u'Documentation', [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ArmorDocs', u'Documentation', author, 'Armor', 'Documentation', 'Miscellaneous'),
]
...
def manage_assets(app, pagename, templatename, context, doctree):
    ...
    individual_js_files = {
        ...
        "armor-documentation": static + "js/min/armor-documentation.min.js?ver=%s" % os.stat(os.path.join(theme_dir, "static/js/min/armor-documentation.min.js")).st_mtime,
    ...
    def get_css_by_page(pagename):
        ...
        default = "css/min/armor-documentation.min.css?ver=%s" % os.stat(os.path.join(theme_dir, "static/css/min/armor-documentation.min.css")).st_mtime
    ...
    def get_js_by_page(pagename):
        ...
        default = [
            individual_js_files['redirects'],
            individual_js_files['armor-documentation']
            # tabs (extension)
            # lightbox (extension)
        ]
...
def creating_file_list(app, exception):
    ...
    if app.builder.name == 'html':
        ...
        for compiled_html in list_compiled_html:
            sitemap += '\t<url><loc>' + requote_uri(html_theme_options.get('armor_doc_url') + '/' + sitemap_version + '/' + compiled_html) + '</loc></url>' + separator
...
html_context = {
    "display_github": True,
    "github_user": "armor",
    "github_repo": "armor-documentation",
    "conf_py_path": "/source/",
