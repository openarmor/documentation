...
Follow the next guide in order to install Armor server:

- :doc:`Install Armor server with RPM packages <../installation-guide/installing-armor-server/armor_server_rpm>`
- :doc:`Install Armor server with Deb packages <../installation-guide/installing-armor-server/armor_server_deb>`
