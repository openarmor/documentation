...
#. Copy the `docker-compose` file to your system:
    ...
    ::
      ...
      $ curl -so docker-compose.yml https://raw.githubusercontent.com/armor/armor-docker/master/docker-compose.yml

#. Start Armor and Elastic Stack using `docker-compose`:
