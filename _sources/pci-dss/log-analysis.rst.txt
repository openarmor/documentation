...
Here we will use Armor log collection and analysis capabilities to meet the following PCI DSS controls:
...
Using the ``sudo`` log analysis decoder and rules, Armor will generate an alert for this particular action and write it to ``alerts.log``. Using the rule tags we can see which PCI DSS requirements are specifically related to this alert.
...
.. thumbnail:: ../images/pci/log_analysis_2.png
    :title: Armor PCI DSS dashboard for Kibana
    :align: center
    :width: 100%

.. thumbnail:: ../images/pci/log-analysis-pci.png
    :title: Armor App PCI section for Kibana
    :align: center
    :width: 100%
