...
We have prepared a few scripts in different languages to help with the task of registering an agent with the API:
    ...
    - `Register an agent using a shell script <https://raw.githubusercontent.com/armor/armor-api/2.0/examples/api-register-agent.sh>`_.
    - `Register an agent using a Python script <https://raw.githubusercontent.com/armor/armor-api/2.0/examples/api-register-agent.py>`_.
    - `Register an agent using a PowerShell script <https://raw.githubusercontent.com/armor/armor-api/2.0/examples/api-register-agent.ps1>`_.
