...
Run the ``update_ruleset.py`` script to update the Armor ruleset.  You should not need to make any other changes to accommodate the updated rules.
...
Run ``update_ruleset.py`` weekly and keep your Armor Ruleset installation up to date by adding a crontab job to your system.
