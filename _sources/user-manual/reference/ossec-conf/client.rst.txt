...
Specify the IP address of the Armor manager.
...
Specify the hostname of the Armor manager.
...
Specify the port on the manager to send events to.  This must match the associated listening port configured on the Armor manager.
