...
This is the full path of the socket that Armor will write alerts/events to for PicViz to read.

+--------------------+---------------------------------------------------------+
| **Default value**  | n/a                                                     |
+--------------------+---------------------------------------------------------+
| **Allowed values** | file and path that Armor will create and feed events to |
+--------------------+---------------------------------------------------------+
...
.. code-block:: xml
    ...
    <global>
      ...
      <smtp_server>smtp.example.armor.com</smtp_server>
      <email_from>ossecm@example.armor.com</email_from>
