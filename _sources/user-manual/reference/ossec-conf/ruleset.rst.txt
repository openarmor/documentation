...
.. note::
    ...
    Do not include the file extension.  Armor will read the .cdb version of the file (the version generated by ossec-makelists from the .txt version of the file.
